...
| laptop | Qwen3-0.6B @ `c1899de…` | Qwen3-1.7B @ `70d244c…` | LoRA | runner implemented; **UNVERIFIED** locally |
| laptop CUDA | same | same | QLoRA | `gsm8k_qlora.yaml`; **NOT EXECUTED** |
...
2.13.0, Transformers 4.57.6, PEFT 0.20.0, Datasets 4.8.5, and Accelerate 1.14.0.
This verifies dependency wiring only; model weights were not downloaded and no Qwen
